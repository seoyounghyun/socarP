...
<head>
   ...
   <link rel="shortcut icon" href="${pageContext.request.contextPath}/bootstrap/img/favicon.png"/>
    ...
    <script>
    	var goList = function() {
    		location.href="<c:url value='/CAR/CarWasteList.do'/>";
		}
    </script>
  ...
  <body>
    <c:import url="/template/Header.jsp" />
      		...
      		<div class="container">
				  ...
				  <h2>폐차 상세보기[${dto.car_i_code}]</h2><br/><br/>
				      	  ...
				      	  <tbody>
					      	  ...
					      	  <tr>
					      	  		<td><label>차량일련번호</label></td>
					      	  		<td>
								      	<span>${dto.car_i_code}</span>
					      	  		</td>
					      	  </tr>
					      	  <tr>
					      	  		<td><label>폐차일</label></td>
					      	  		<td>
					      	  			<span>${dto.car_w_date}</span>
								    </td>
					      	  </tr>
					      	  <tr>
					      	  		<td><label>폐차사유</label></td>
					      	  		<td>
					      	  			<span>${dto.car_w_reason}</span>
					      	  		</td>
					      	  </tr>      	  
					      </tbody>
