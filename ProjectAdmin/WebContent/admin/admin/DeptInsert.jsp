  ...
  <body>
    <c:import url="/template/Header.jsp" />
   		...
   		<div class="container">
				  ...
				  <h2>부서 입력</h2><br/><br/>
				    <form action="<c:url value='/Admin/InsertDept.do'/>" method="post">
				      	  ...
				      	  <tbody>
					      	  ...
					      	  <tr>
					      	  		...
					      	  		<td>
								      	<div class="col-xs-5">
								        <input type="text" class="form-control" value="${dto.dept_no}" name="dept_no" id="dept_id"/>
								     	</div>
					      	  		</td>
					      	  </tr>
					      	  <tr>
					      	  		...
					      	  		<td><div class="col-xs-5">
					      	  			<input type="text" class="form-control" value="${dto.dept_name }" name="dept_name" id="dept_name_id"/>
								    </div></td>
					      	  </tr>
					      	  <tr>
								    ...
								    <td>
					      	  			<textarea name="dept_desc" rows="20" cols="80" class="form-control" id="dept_desc_id">${dto.dept_desc}</textarea>
								    </td>
					      	  </tr>
				      ...
				      <button type="submit" class="btn btn-info" onclick="return goListInsert()">입력하기</button>
