...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	<head>
		...
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/ssun.js?1503566859"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/json3.min.js?1503566859"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/common.js?1503566859"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/day-picker.js?1503566859"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/jquery.block.ui.min.js?1503566859"></script>
		<script>
...
<!-- //lnb -->
				<div class="section">
					...
					<form name="inquiry" method="post" action="https://api.socar.kr/cs/counsel" accept-charset="utf-8" enctype="multipart/form-data">
						<fieldset>
						<input type="hidden" name="auth_token" value="7fb61d6678ad74f167bd4d7f6f3181453c89ff40kjmtg" />
...
<script type="text/javascript" src="//web-assets.socar.kr/template/./asset/js/kakao.min.js?1503566859" charset="utf-8"></script>
<script type="text/javascript" src="//web-assets.socar.kr/template/./asset/js/sns_interlocking.js?1503566859" charset="utf-8"></script>
