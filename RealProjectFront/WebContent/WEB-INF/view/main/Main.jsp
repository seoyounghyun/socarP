...
<script type="text/javascript" src='//dt0fe0zcu6ite.cloudfront.net/template/asset/slick_slider/slick.min.js?v=1'></script>

<link rel="stylesheet" type="text/css" href='//dt0fe0zcu6ite.cloudfront.net/template/asset/slick_slider/slick.css' />
<link rel="stylesheet" type="text/css" href='//dt0fe0zcu6ite.cloudfront.net/template/asset/slick_slider/slick-theme.css' />
<link rel="stylesheet" href='//dt0fe0zcu6ite.cloudfront.net/template/asset/css/font-awesome.min.css' />
<link rel="stylesheet" type="text/css" href='//dt0fe0zcu6ite.cloudfront.net/template/asset/css/main.css?v=20170731' />
<style type="text/css">
...
#main_banner_n .prev {display:block;overflow:hidden;position:absolute;top:140px;left:0;width:82px;height:138px;background:url('//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/main_banner_new_btn.png') 0 0 no-repeat;text-indent:-9999px;}
#main_banner_n .prev:hover {background-position:-150px 0;}
#main_banner_n .next {display:block;overflow:hidden;position:absolute;top:140px;right:0;width:82px;height:138px;background:url('//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/main_banner_new_btn.png') 0 -200px no-repeat;text-indent:-9999px;}
...
$(document).ready(function() {
	...
	<div class="tvc-banner">
		<a class="banner-container" href="http://pr.socar.kr/sa06" target="_blank">
			<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/tvc_banner_1.jpg?v=20170726' class="banner-image" role="presentation" />
		</a>
		<a class="banner-container" href="http://pr.socar.kr/sa06" target="_blank">
			<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/tvc_banner_2.jpg?v=20170726' class="banner-image" role="presentation" />
		</a>
		<a class="banner-container" href="http://pr.socar.kr/sa06" target="_blank">
			<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/tvc_banner_3.jpg?v=20170726' class="banner-image" role="presentation" />
		</a>
		<a class="banner-container" href="http://pr.socar.kr/sa06" target="_blank">
			<img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/tvc_banner_4.jpg?v=20170726' class="banner-image" role="presentation" />
		</a>
	</div>
	<div id="container">
		<div id="content">
			...
			<div id="visual">
				<div class="clsBannerScreen">
					<div class="images" style="display:block"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/visual1_170719.png' usemap="#visual3" alt="" /></div>
					<div class="images" style="display:none"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/visual2_160322.png' usemap="#visual2" alt="" /></div>
					<div class="images" style="display:none"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/visual3_160322.png' usemap="#visual1" alt="" /></div>
					<div class="images" style="display:none"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/visual4_160322.png' usemap="#visual4" alt="" /></div>
				</div>
				...
				<div class="movie_layer">
					...
					<div class="movie" id="movie">
						<div class="close"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/movie_close.png' id="movie_layerClose" alt="" /></div>
			...
			<div class="loginBox">
					...
					<!-- 로그인 전 -->
					<div class="group">
						<p class="txt"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/right_login_txt1_three_hours.png' alt="즐거운 드라이브 라이프의 시작 가입하면 첫사용 무료! 타면된다 쏘카!" /></p>
						<p class="btn">
							<a href="/join"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/btn_join.png' alt="회원 가입하기" /></a>
						</p>
					</div>
					<!-- //로그인 전 -->
...
<div id="banner01" class="banner01" >
	...
	<a href="/company"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/banner_person.png' alt="업무용 카셰어링 지원" /></a></div>
...
<div id='banner02' class='banner02' style='top:242px'><a href='http://www.socar.kr/garage' target='_self'><img src='https://d353obgi8xzt9w.cloudfront.net/banner/banner_2.png' alt='차종다양화' title='차종다양화' width='226' height='74' /></a></div><div id='banner03' class='banner03' style='top:321px'><a href='https://goo.gl/8w3ExU' target='_blank'><img src='https://d353obgi8xzt9w.cloudfront.net/banner/쏘카채용중_웹배너_226X74.png' alt='쏘카 채용사이트 오픈' title='쏘카 채용사이트 오픈' width='226' height='74' /></a></div>
			...
			<div class="rule">
				...
				<div class="rule2">
					...
					<!-- <a href="#" class="more"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/btn_more.png' alt="더보기" /></a> -->
				</div>
				<!-- //쏘카 이용규칙 -->
			</div>
			<div class="notice">
				...
				<div class="notice1">
					...
					<ul>
							...
							<li>
								<a href=https://www.socar.kr/notice/859>
									[매너평가] GOOD & BAD...							
									   <img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/ico_new.png' alt="새글" />				
								</a>
							</li>
						
							<li>
								<a href=https://www.socar.kr/notice/858>
									[이벤트] 쏘카x카카오톡 장보기...				
								</a>
							</li>
						
							<li>
								<a href=https://www.socar.kr/notice/857>
									[매너평가] GOOD & BAD...				
								</a>
							</li>
						
							<li>
								<a href=https://www.socar.kr/notice/856>
									[이벤트] 쏘카 x 스팅어 무료...
								</a>
							</li>
						
							<li>
								<a href=https://www.socar.kr/notice/855>
									[매너평가] GOOD & BAD...
								</a>
							</li>
						
					</ul>
					<a href="/notice" class="more"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/btn_more.png' alt="더보기" /></a>
				</div>
				<!-- //공지사항 -->
				...
				<div class="notice2">
					...
					<a href="/faq" class="more"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/main/btn_more.png' alt="더보기" /></a>
				</div>
				<!-- //자주묻는 질문 -->
			</div>
		</div>
...
<script type="text/javascript" src="//web-assets.socar.kr/template/./asset/js/kakao.min.js?1503313225" charset="utf-8"></script>
<script type="text/javascript" src="//web-assets.socar.kr/template/./asset/js/sns_interlocking.js?1503313225" charset="utf-8"></script>
	...
	<form name="request" method="post" action="">
		<fieldset>
			<div class="cardForm">
				...
				<input id="btn_reg_card" type="image" src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/common/btn_card_add.png' class="submit" alt="등록" />
			</div>
		</fieldset>
	</form>
	<p class="txt"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/common/card_reg_required_txt.png' alt="회원번호를 입력해주세요!" /></p>
	<a href="#" class="close"><img src='//dt0fe0zcu6ite.cloudfront.net/template/asset/images/common/card_close.png' alt="다음에 등록" /></a>
</div>
<!-- //카드 등록 -->
	</div>
</div>
