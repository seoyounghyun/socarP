...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	<head>
		...
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/ssun.js?1503563932"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/json3.min.js?1503563932"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/common.js?1503563932"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/day-picker.js?1503563932"></script>
		<script type="text/javascript" src="//web-assets.socar.kr/template/asset/js/jquery.block.ui.min.js?1503563932"></script>
		<script>
  ...
  $("#simple-join").bind('click',function() {
    ...
    if(mobile == '') {
      ...
      if(!regExp.test(mobile)) {
        alert('잘못된 휴대폰 번호입니다. (-)을 제외한 숫자만 입력해주세요.');
        return false;
      }
    }
    ...
    <div id="content">
      ...
      <form name="join" method="post" action="">
        <fieldset>
          <div class="type box">
            <ul>
            <li class="first" style="padding-left: 40%">
              ...
              <p class="btn">
                <img src='//web-assets.socar.kr/template/asset/images/member/btn_join.png' class="simple_join" style="padding-left:50%; padcursor:pointer;" alt="가입하기" />
              </p>              
            </li>
            ...
            <div id="member_referer" class="check">
              <h4><img src='//web-assets.socar.kr/template/asset/images/member/join_index_txt12_refer.gif' alt="안내받은 제휴코드를 입력해주세요." id='refer_direction' /></h4>
              <p><img src='//web-assets.socar.kr/template/asset/images/member/join_index_txt13_refer.gif' alt="일부 숫자와 영문이 혼동될 수 있습니다. 정확히 입력해주세요." /></p>
              <p class="ch">
                <input id="input_member_referer" type="text" class="input" value="" />
                <input id="btn_member_referer_submit" type="image" src='//web-assets.socar.kr/template/asset/images/common/btn_confirm_b_s.gif' title="확인" />
              </p>
...
<div class="joinSNS mwCont" style="display: block;">
	...
	<div class="tit"><img src='//web-assets.socar.kr/template/asset/images/member/txt_email_n.gif' alt="이메일 계정으로 가입하기" /></div>
	<div class="box_email"><input type="text" id="join_input_email" onclick="$(this).css('background','none')" name="join_input_email" class="email input" /><a href="#" class="join" id="email_join"><img src='//web-assets.socar.kr/template/asset/images/member/new/btn_join.gif' alt="회원가입" onclick="javascript:ga_call('email_join_click')" /></a></div>
</div>
...
<div class="joinSNS_Info mwCont">
	<dl>
		...
		<dd style="position:relative;"><input type="text" id="join_email" name="join_email" class="input" value="" />
	...
	<div class="box_btn">
		<a href="#" id="simple-join"><img src='//web-assets.socar.kr/template/asset/images/member/new/btn_joinok.gif' alt="간편가입 완료" /></a>
	</div>
...
<div class="joinSNS_result mwCont" style="margin-top: 30px;">
	<div class="img"><img src='//web-assets.socar.kr/template/asset/images/member/new/bg_join.gif' alt="간편가입이 완료되었습니다. 차량 예약 및 이용을 하시려면 운전면허/결제정보를 등록하여 SO회원으로 가입을 완료해 주셔야 합니다." /></div>
	<div class="line"></div>
	<div class="box_btn">
		<a href="#" class="join_pr" id="join_continue"><img src='//web-assets.socar.kr/template/asset/images/member/new/btn_joinnext.gif' alt="가입 계속하기" /></a>
		<a href="#" class="join_pr" id="join_later"><img src='//web-assets.socar.kr/template/asset/images/member/new/btn_lt.gif' alt="나중에 가입" /></a>
	</div>
</div>
<!-- login -->
<div class="login mwCont">
	...
	<ul>
		<li><a title="회원가입" class="lg1" href="<c:url value='/Member/Join.do' />"><img src='//web-assets.socar.kr/template/asset/images/common/new/join.png' alt="회원가입" /></a></li>
...
<script type="text/javascript" src="//web-assets.socar.kr/template/./asset/js/kakao.min.js?1503563932" charset="utf-8"></script>
<script type="text/javascript" src="//web-assets.socar.kr/template/./asset/js/sns_interlocking.js?1503563932" charset="utf-8"></script>
