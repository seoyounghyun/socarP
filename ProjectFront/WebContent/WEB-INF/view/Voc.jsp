...
<head>
		...
		<script type="text/javascript" src="/template/asset/js/ssun.js?1505264689"></script>
		<script type="text/javascript" src="/template/asset/js/json3.min.js?1505264689"></script>
		<script type="text/javascript" src="/template/asset/js/common.js?1505264689"></script>
		<script type="text/javascript" src="/template/asset/js/day-picker.js?1505264689"></script>
		<script type="text/javascript" src="/template/asset/js/jquery.block.ui.min.js?1505264689"></script>
		<script>
...
<!-- //lnb -->
        <div class="section">
          <h3><img src='//web-assets.socar.kr/template/asset/images/customer/voc_title.png' alt="고객의견 반영절차"/></h3>
          <img src='//web-assets.socar.kr/template/asset/images/customer/voc_contents.png?v=20160809'  alt="고객의견 반영절차" />
        </div>
      </div>
    </div>
...
<script type="text/javascript" src="/template/./asset/js/kakao.min.js?1505264689" charset="utf-8"></script>
<script type="text/javascript" src="/template/./asset/js/sns_interlocking.js?1505264689" charset="utf-8"></script>
